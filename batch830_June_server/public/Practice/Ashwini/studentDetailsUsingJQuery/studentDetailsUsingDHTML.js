			...
			if(temp == "India"){
				for(temp1 in states.India){
					if(typeof(states.India[temp1]) == 'object'){
						let a = temp1;
						var opt = $("<option></option").appendTo("#inputOfState");
...
function selectCity(){
	...
	if(state == "Telangana"){
		for(var temp in states.India.Telangana){
			...
			opt.text(states.India.Telangana[temp]);	
		}
	}
	if(state == "Tamil_Nadu"){
		for(var temp in states.India.Tamil_Nadu){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.India.Tamil_Nadu[temp]);	
		}
	}
	if(state == "Kerala"){
		for(var temp in states.India.Kerala){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.India.Kerala[temp]);	
		}
	}
	if(state == "BritishColumbia"){
		for(var temp in states.Canada.BritishColumbia){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.Canada.BritishColumbia[temp]);	
		}
	}
	if(state == "Ontario"){
		for(var temp in states.Canada.Ontario){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.Canada.Ontario[temp]);	
		}
	}
	if(state == "Saskaswan"){
		for(var temp in states.Canada.Saskaswan){
			var opt = $("option").appendTo("#inputOfCity");
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.Canada.Saskaswan[temp]);	
		}
	}
	if(state == "Novascotia"){
		for(var temp in states.Canada.Novascotia){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.Canada.Novascotia[temp]);	
		}
	}
	if(state == "Washington"){
		for(var temp in states.USA.Washington){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.USA.Washington[temp]);	
		}
	}
	if(state == "New_York"){
		for(var temp in states.USA.New_York){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.USA.New_York[temp]);	
		}
	}
	if(state == "Texas"){
		for(var temp in states.USA.Texas){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.USA.Texas[temp]);	
		}
	}
	if(state == "Florida"){
		for(var temp in states.USA.Florida){
			...
			//document.querySelector("#inputOfCity").append(opt);
			//console.log(states.India.Andhra_Pradesh[temp]);
			opt.text(states.USA.Florida[temp]);	
		}
	}
}